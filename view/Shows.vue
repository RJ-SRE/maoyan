      ...
      concerts: [
        {
          id: 1,
          title: '周杰伦演唱会2024',
          poster: 'https://via.placeholder.com/300x400/e54847/fff?text=演唱会1',
          venue: '国家体育场(鸟巢)',
        ...
        },
        {
          ...
          poster: 'https://via.placeholder.com/300x400/4a90e2/fff?text=演唱会2',
          venue: '工人体育场',
        ...
        },
        {
          id: 3,
          title: '新年交响音乐会',
          poster: 'https://via.placeholder.com/300x400/7ed321/fff?text=音乐会',
          venue: '国家大剧院',
        ...
        },
        {
          id: 4,
          title: '钢琴独奏会',
          poster: 'https://via.placeholder.com/300x400/f5a623/fff?text=钢琴',
          venue: '中山音乐堂',
      ...
      dramas: [
        {
          id: 5,
          title: '《茶馆》经典话剧',
          poster: 'https://via.placeholder.com/300x400/bd10e0/fff?text=话剧1',
          venue: '首都剧场',
        ...
        },
        {
          id: 6,
          title: '《悲惨世界》音乐剧',
          poster: 'https://via.placeholder.com/300x400/50e3c2/fff?text=音乐剧',
          venue: '上海文化广场',
      ...
      dances: [
        {
          id: 7,
          title: '《天鹅湖》芭蕾舞剧',
          poster: 'https://via.placeholder.com/300x400/b8e986/fff?text=芭蕾',
          venue: '国家大剧院',
        ...
        },
        {
          id: 8,
          title: '现代舞专场',
          poster: 'https://via.placeholder.com/300x400/9013fe/fff?text=现代舞',
          venue: '北京舞蹈学院剧场',
      ...
      sports: [
        {
          id: 9,
          title: 'CBA篮球联赛',
          poster: 'https://via.placeholder.com/300x400/d0021b/fff?text=篮球',
          venue: '五棵松体育馆',
        ...
        },
        {
          id: 10,
          title: '羽毛球公开赛',
          poster: 'https://via.placeholder.com/300x400/4a4a4a/fff?text=羽毛球',
          venue: '国家体育馆',
